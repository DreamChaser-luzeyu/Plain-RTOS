...
extern volatile uint32_t UserProcess_1_Stack_GArr[32];
extern volatile uint32_t UserProcess_2_Stack_GArr[32];
extern volatile uint32_t UserProcess_3_Stack_GArr[32];
